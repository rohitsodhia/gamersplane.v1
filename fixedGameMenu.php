...
?>
		<ul class="rightCol">
			<li><a href="<?=SITEROOT.'/tools/maps/?gameID='.$gameID?>" class="menuLink">Maps</a></li>
			...
			<li id="fm_tools">
				...
				<ul class="submenu" data-menu-group="tools">
					...
					<li id="fm_cards">
						...
						<div class="subwindow">
<?php $cardCount = isset($_SESSION['deck']) && count($_SESSION['deck'])?array_count_values($_SESSION['deck']):array(0, 0); ?>
							<div class="cardControls">
								...
								<div><button type="submit" name="drawCards" class="drawCards">Draw Cards</button></div>
								<a href="?newDeck=1" class="newDeckLink">New Deck</a>
							</div>
							<div id="fm_dispArea">
