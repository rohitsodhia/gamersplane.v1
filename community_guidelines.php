<? require_once(FILEROOT.'/header.php'); ?>
		...
		<p>All members are entitled to respect. Gamers' Plane welcomes diverse viewpoints on gaming, and that will by definition include disagreement. However, we explicitly stand against hate and discrimination. This community is and will remain a safe and welcoming space for minorities and marginalized groups. Any discussion or debate should remain respectful and focused on the topic rather than on the individuals involved. Harassment, hate speech, and personal attacks are not permitted. This includes, but is not limited to: name-calling, belittling, bullying, or the use of slurs or derogatory language based on race, ethnicity, national origin, religion, disability, gender, gender identity, sexual orientation, or age.</p>

		<h2>Content Standards</h2>
		<p>Gamers' Plane is a site dedicated to gaming and the community around the games. With that in mind, discussions should primarily relate to gaming. Please avoid introducing divisive off-topic subjects such as politics, religion, or other current events not directly related to gaming. In particular, please note the following when posting in the public forums or on Discord:</p>
		<ol>
			<li><strong>Spam:</strong> Threads and posts should have clear content and purpose, whether introducing yourself or starting a discussion on a topic. Avoid spammy posts. Limit images to three per post and ensure they are relevant to the discussion.</li>
			<li><strong>Explicit Material & Profanity:</strong> We strive to maintain an environment appropriate for a general audience. Do not post pornography, sexually explicit content, or realistic depictions of gratuitous violence. Also, please refrain from excessive profanity. If it would get you an adult rating in a theater, it’s too much for Gamers' Plane.</li>
			<li><strong>Legally Prohibited Content:</strong> You may not post or share anything that is libelous, defamatory, or threatening, or that violates copyright or other intellectual property rights. This includes sharing or linking to copyrighted material without permission from the rights holder.</li>
			<li><strong>Site Security:</strong> You may not take any action intended to harm Gamers' Plane, its servers, or its content, nor may you attempt to circumvent its security measures. This includes, but is not limited to: posting on the site from two different accounts at the same time in secret. You may switch to a new account, but any disciplinary actions that applied to your old account will apply to your new account. Creating accounts to circumvent disciplinary actions or engage in inauthentic behaviour will result in an immediate ban.</li>
			<li><strong>Advertising:</strong> Promotion of commercial products or services is permitted only in the designated subforum or discord channel. You must be an existing member of the community in order to make posts advertising any product. All advertising must follow all other rules. Advertisements that follow a known pattern of scammers may be removed.</li>
			...
			<li><strong>Non-English Posts:</strong> Posts in public forums should be in English unless the thread is tagged for another language (e.g. [French], [German]) as the mods do not all speak other languages. If you do not include an English translation with your post, computer-based translation will be considered authoritative in the event of moderation.</li>
		...
		<p>Private game forums may permit looser language standards, provided this is clearly stated at the root forum or in the game details. Even in these spaces, users must abide by all other rules. Games may be run in other languages but should be tagged as noted in the previous section.</p>
