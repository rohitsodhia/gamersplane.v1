...
<?	} ?>
				...
				<div id="qualities">
					...
					<div class="hbdMargined"><?=$this->getQualities()?></div>
				</div>
			...
			<div class="clearfix">
				<div id="skills" class="twoCol floatLeft">
					...
					<div class="hbdMargined"><?=$this->getSkills()?></div>
				</div>
				<div id="spells" class="twoCol floatRight">
					<h2 class="headerbar hbDark">Spells</h2>
					<div class="hbdMargined"><?=$this->getSpells()?></div>
				</div>
			</div>
			...
			<div class="clearfix">
				...
				<div id="armor" class="twoCol floatRight">
					...
					<div class="hbdMargined"><?=$this->getArmor()?></div>
				</div>
			</div>
			...
			<div class="clearfix">
				<div id="augments" class="twoCol floatLeft">
					...
					<div class="hbdMargined"><?=$this->getAugments()?></div>
				</div>
				<div id="contacts" class="twoCol floatRight">
					<h2 class="headerbar hbDark">Contacts</h2>
					<div class="hbdMargined"><?=$this->getContacts()?></div>
				</div>
			</div>
