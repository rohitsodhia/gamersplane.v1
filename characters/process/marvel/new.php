<?
	...
	if (isset($_POST['submit'])) {
		...
		$mysql->query('UPDATE marvel_characters SET '.setupUpdates(array('unusedStones' => formatStones($_POST['startingStones']), 'normName' => sanitizeString($_POST['normName']), 'superName' => sanitizeString($_POST['superName']))).' characterID = '.$characterID);
