...
<?	} ?>
			<p><a href="http://gamersplane.com/user/<?=$currentUser->userID?>/" class="username"><?=$currentUser->username?></a> has invited you to their <?=$gameInfo['fullName']?> game, "<a href="/games/<?=$gameID?>/"><?=$gameInfo['title']?></a>"!</p>
