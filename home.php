<?php
	...
	$gamesForumManager = new ForumManager(2);
	$forumSearchGames = new ForumSearch('latestGamePosts',array(),$gamesForumManager);
...
<?php
	$forumSearchPublic = new ForumSearch('latestPublicPosts' , array() , $gamesForumManager);
...
<?php
	if ($gamesForumManager->hasForums(ForumManager::FAVOURITE)) {
?>
			<div class="flexWrapper mob-order-2">
				...
				<?php
					$gamesForumManager->displayForum(ForumManager::FAVOURITE);
				?>
				</div>
			</div>
<?php
	...
	if ($gamesForumManager->hasForums(ForumManager::NON_FAVOURITE)) {
?>
			<div class="flexWrapper mob-order-2">
				<div id="yourGames" class="col-1">
					<h3 class="headerbar"><a href="/forums/2"><i class="ra ra-d6"></i> Your Games</a></h3>
<?php
		$gamesForumManager->displayForum(ForumManager::NON_FAVOURITE);
?>
				</div>
			</div>
<?php
