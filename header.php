		...
		<ul id="mainMenu">
			...
			<li>
				...
				<li><a href="/games/my/"><i class="ra ra-gamers-plane"></i> All games</a></li>
					<li ng-repeat="game in games | limitTo: 10"><a href="/forums/{{game.forumID}}/" title="Forum"><i class="ra ra-speech-bubble"></i></a><a href="/games/{{game.gameID}}/" title="Game"><i class="ra {{game.isPlayer?'ra-d6':'ra-bookmark'}}"></i> <span ng-bind-html="game.title | trustHTML"></span> <img ng-if="game.isGM" src="/images/gm_icon.png"></a></li>
				</ul>
			</li>
