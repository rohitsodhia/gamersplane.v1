		...
		<div class="flexWrapper">
			...
			<div class="mainColumn right">
				...
				<div class="alignRight">
					<div id="numResults" ng-show="filter.search.length"><strong>{{filteredSystems.length}}</strong> System{{filteredSystems.length > 1?'s':''}} Found</div>
				...
				<div id="systems">
					<div class="system clearfix" ng-repeat="system in filteredSystems = (systems | filter:{ name: filter.search }) | paginateItems: 10:(pagination.current - 1) * 10">
						<div class="leftCol">
							<div class="logo"><img src="/images/logos/{{system.id}}.png"></div>
							<p><a href="/games/list/?filter=filter&filterSystem%5B%5D={{system.id}}">Find games</a> | <a href="/games/new/?system={{system.id}}">Start a game</a></p>
						</div>
						<div class="info">
							<h2 ng-bind-html="system.name | trustHTML"></h2>
							<div ng-if="system.name=='Custom'">
