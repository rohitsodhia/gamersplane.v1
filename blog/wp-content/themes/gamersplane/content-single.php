...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		<?php
			...
			if ( '' != $tag_list ) {
				$utility_text = 'This entry was posted in %1$s with the tags %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
			} elseif ( '' != $categories_list ) {
				$utility_text = 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
			} else {
				$utility_text = 'This entry was posted. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
			}
