<?
	...
	if (isset($_POST['delete'])) {
 		if (($threadManager->getPermissions('moderate') || $post->getAuthor('userID') == $currentUser->userID) && $postID != $threadManager->getFirstPostID() && $threadManager->getPermissions('deletePost')) {
