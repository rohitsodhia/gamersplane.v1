...
<ul>
	<li ng-repeat="forum in forums | filter: { parentID: forum.forumID }:true" ng-include="'forumList'"></li>
</ul>
</script>
		<div id="forums" class="column">
			<h2 class="headerbar hbDark">Forums</h2>
			<ul>
				<li ng-repeat="forum in forums | filter: { parentID: 0 }:true" ng-include="'forumList'"></li>
			</ul>
		</div>
