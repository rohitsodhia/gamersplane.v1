<div ng-click="$event.stopPropagation()" class="combobox" ng-class="{ 'autocomplete': usingAutocomplete, 'focused': hasFocus }">
	<input type="text" ng-model="search" ng-class="{ resultsOpen: showDropdown && filterData().length }" ng-change="showDropdown = true" ng-focus="inputFocused()" ng-blur="inputBlurred()" ng-keydown="navigateResults($event)">
