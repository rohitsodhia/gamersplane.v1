<?php
	if (isset($_POST['toggle'])) {
		...
		if (!$getGame->rowCount()) {
			...
			$mysql->query("UPDATE players SET isGM = NOT isGM WHERE gameID = {$gameID} AND userID = {$playerID} LIMIT 1");
			if ($isGM) {
