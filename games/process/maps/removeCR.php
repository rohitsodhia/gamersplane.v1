<?
	...
	$mapInfo = $mysql->query("SELECT maps.rows, maps.columns, maps.bgData FROM maps INNER JOIN players ON maps.gameID = players.gameID AND players.isGM = 1 WHERE players.userID = {$currentUser->userID} AND maps.mapID = $mapID");
