...
<? if ($isGM) { ?>
		<p>Are you sure you want to remove <a href="<?='/user/'.$playerInfo['userID']?>" class="username"><?=$playerInfo['username']?></a> as a GM?</p>
...
<? } else { ?>
		<p>Would you like to make <a href="<?='/user/'.$playerInfo['userID']?>" class="username"><?=$playerInfo['username']?></a> a GM?</p>
