<?
	class 13thageCharacter extends d20Character {
		...
		public function __construct($characterID, $userID = null) {
			unset($this->ac, $this->attackBonus);
		...
		public function getBackground() {
			return $this->background;ac		}

		public function setAlignment($value) {
			if (13thage_consts::getAlignments($value) && $value != null) 
				$this->alignment = $value;
		}

		public function getAlignment() {
			return 13thage_consts::getAlignments($this->alignment);
		}
