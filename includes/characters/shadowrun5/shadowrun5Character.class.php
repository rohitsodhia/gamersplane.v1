<?
	class shadowrun5Character extends Character {
		...
		protected $metatype = '';
		protected $reputation = ['street' => 0, 'notoriety' => 0, 'public' => 0];
		protected $karma = ['spent' => 0, 'total' => 0];
		protected $stats = [
			'body' => 0,
			'agility' => 0,
			'reaction' => 0,
		...
		protected $limits = ['physical' => 0, 'mental' => 0, 'social' => 0];
		protected $damage = ['physical' => ['modify' => 0, 'current' => 0, 'overflow' => 0], 'stun' => ['modify' => 0, 'current' => 0]];
		protected $skills = [];
		protected $qualities = [];
		protected $contacts = [];
		protected $weapons = ['ranged' => [], 'melee' => []];
		protected $armor = [];
		protected $cyberdeck = ['model' => '', 'rating' => 0, 'attack' => 0, 'sleaze' => 0, 'data' => 0, 'firewall' => 0, 'programs' => [], 'condition' => 0, 'notes' => ''];
